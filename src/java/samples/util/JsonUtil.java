...
public class JsonUtil {
	...
	public static Gson getGson() {
		if (gson == null) {
			gson = new GsonBuilder().setPrettyPrinting()/*.setExclusionStrategies(new AnnotationExclusion())*/.create();
		}
...
/*	public static JsonError toError(Throwable ex) {
		...
		// return new error
		JsonError error = new JsonError(ex.getClass().getCanonicalName()+": "+ex.getMessage(), additionalInformation.toArray(new String[]{}));
		return error;
	}
	*/
